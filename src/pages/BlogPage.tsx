        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white text-sm sm:text-base placeholder:text-silver-dark focus:outline-none focus:border-silver"
            />
            <button
              onClick={() => navigate('contact')}
              className="px-5 sm:px-6 py-3 bg-white text-charcoal font-bold text-sm sm:text-base rounded-lg hover:bg-cloud-light transition-colors whitespace-nowrap"
            >
              Subscribe
            </button>
          </div>
