    ...
    <div className="font-['Inter',sans-serif]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
          <div className="max-w-3xl">
            <span className="text-silver-light font-semibold text-xs sm:text-sm uppercase tracking-wider">About Us</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            <div>
              ...
              <p className="text-silver-darker text-sm sm:text-base leading-relaxed mb-6 sm:mb-8">
                Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae.
              </p>
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                {[
                  ...
                  <div key={stat.label}>
                    ...
                    <p className="text-xs sm:text-sm text-silver-dark mt-0.5">{stat.label}</p>
                  </div>
                ))}
              </div>
            </div>
            <TexImg src={IMG.fabricRolls1} alt="Fabric rolls" className="w-full h-[300px] sm:h-[400px] lg:h-[450px] rounded-xl sm:rounded-2xl order-first lg:order-last" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-14">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-charcoal mt-2 sm:mt-3">The TexVista Advantage</h2>
          </div>
