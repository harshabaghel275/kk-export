...
const products = [
  { id: 1, category: 'MENSWEAR DIVISION', name: 'Round Neck T-Shirts', desc: 'High-quality cotton and blended round neck T-shirts manufactured in multiple GSM options for retail, corporate, and export markets.', img: '/image/FULLMENSWEAR.jpg', specs: ['Fabric: 100% Cotton / Cotton Blend','GSM: 160–240 GSM','Sizes: S to XXL (Custom Sizes Available)','Fit: Regular / Slim Fit','Customization: Printing & Embroidery Available'] },
  { id: 2, category: 'MENSWEAR DIVISION', name: 'Polo / Collar T-Shirts', desc: 'Premium polo T-shirts in cotton, poly-cotton, and performance fabrics, ideal for corporate branding and promotional supply.', img: '/image/MENSWEAR2.jpg', specs: ['Fabric: Cotton / Poly-Cotton / Pique','GSM: 180–260 GSM','Sizes: S to XXL','Collar: Ribbed / Flat Knit','Branding: Logo Embroidery / Screen Print'] },
  { id: 3, category: 'MENSWEAR DIVISION', name: 'Formal & Casual Shirts', desc: 'Well-constructed shirts with precision stitching and finishing, suitable for domestic and international bulk buyers.', img: '/image/MENSWEAR3.jpg', specs: ['Fabric: 100% Cotton / Poly-Cotton / Linen','GSM: 120–200 GSM','Sizes: S to XXL (Custom Sizes Available)','Fit: Regular / Slim / Tailored Fit','Features: Premium Stitching & Color Fastness'] },
  { id: 4, category: 'MENSWEAR DIVISION', name: 'Corporate & Institutional Uniforms', desc: 'Customized uniform manufacturing with logo branding, embroidery, and private labeling options.', img: '/image/MENSWEAR4.jpg', specs: ['Fabric: Cotton / Poly-Cotton / Blended Fabric','GSM: 180–300 GSM','Sizes: XS to XXXL (Custom Sizes Available)','Customization: Logo Printing & Embroidery','Features: Durable Stitching & Color Fastness'] },
  { id: 5, category: 'BULKPROMOTIONAL', name: 'White Cotton T-Shirts', desc: '100% cotton promotional T-shirts designed for large distribution and campaign use.', img: '/image/FULLBULKT-SHIRT3.jpg', specs: ['Fabric: 100% Combed Cotton','GSM: 160–220 GSM','Sizes: S to XXL (Custom Sizes Available)','Color: Optical White / Bio-Washed Finish','Usage: Printing, Promotions & Campaign Distribution'] },
  { id: 6, category: 'BULKPROMOTIONAL', name: 'Black Bulk T-Shirts', desc: 'Budget-friendly black T-shirts suitable for printing and branding applications.', img: '/image/FULLBULKT-SHIRT2.jpg', specs: ['Fabric: Cotton / Cotton Blend','GSM: 160–240 GSM','Sizes: S to XXL','Color: Reactive Dyed Black (Color Fast)','Suitable For: Screen Printing & Branding'] },
  { id: 7, category: 'BULKPROMOTIONAL', name: 'Navy Blue Promotional T-Shirts', desc: 'High-demand navy blue T-shirts produced for corporate and export markets.', img: '/image/FULLBULKT-SHIRT1.jpg', specs: ['Fabric: 100% Cotton / Poly-Cotton','GSM: 180–240 GSM','Sizes: S to XXL (Bulk Production Available)','Color: Navy Blue (Export Quality Dye)','Application: Corporate Gifting & Promotional Events'] },
  { id: 8, category: 'HOMETEXTILE', name: 'Bath Towels', desc: 'Highly absorbent cotton terry bath towels available in various GSM ranges and custom sizes.', img: '/image/TOWEL1.jpg', specs: ['Fabric: 100% Cotton Terry','GSM: 400–700 GSM','Sizes: 70x140 cm / Custom Sizes Available','Features: High Absorbency & Soft Finish','Suitable For: Hotels, Resorts & Export Markets'] },
  { id: 9, category: 'HOMETEXTILE', name: 'Hand Towels', desc: 'Durable and soft hand towels designed for hotels and commercial buyers.', img: '/image/TOWEL2.jpg', specs: ['Fabric: 100% Cotton / Cotton Blend','GSM: 350–600 GSM','Sizes: 30x30 cm / 40x60 cm','Features: Durable, Quick Absorb & Color Fast','Application: Hospitality & Commercial Use'] },
  { id: 10, category: 'FABRICDIVISION', name: 'Suiting Fabrics', desc: 'Premium suiting fabrics in multiple blends, finishes, and textures suitable for formal wear production.', img: '/image/SUITING1.jpg', specs: ['Composition: Wool / Polyester / Blended','GSM: 180–350 GSM','Width: 58–60 Inches','Finish: Soft Finish / Wrinkle Resistant','Application: Formal & Business Wear'] },
  { id: 11, category: 'FABRICDIVISION', name: 'Shirting Fabrics', desc: 'Soft, breathable, and durable shirting fabrics available in cotton and blended compositions.', img: '/image/SUITING2.jpg', specs: ['Composition: 100% Cotton / Poly-Cotton','GSM: 100–180 GSM','Width: 44–58 Inches','Features: Breathable & Color Fast','Suitable For: Casual & Formal Shirts'] },
  { id: 12, category: 'DENIMDIVISION', name: 'Denim Fabric Sourcing', desc: 'All types of denim fabrics available in various weights, shades, and finishes.', img: '/image/DENIM1.jpg', specs: ['Composition: 100% Cotton / Stretch Denim','GSM: 250–400 GSM (8–14 Oz)','Width: 58–60 Inches','Finish: Rinse Wash / Stone Wash / Raw','Shrinkage: Controlled & Pre-Shrunk'] },
  { id: 13, category: 'DENIMDIVISION', name: 'Denim Jeans Manufacturing', desc: 'Complete jeans production including custom fits, washes, and private label branding.', img: '/image/DENIM2.jpg', specs: ['Fabric: Rigid / Stretch Denim','Sizes: 28–40 (Custom Sizes Available)','Fit: Slim / Regular / Relaxed','Wash Types: Stone / Enzyme / Acid Wash','Branding: Private Label & Custom Tags'] },
  { id: 14, category: 'CUSTOMMANUFACTURING', name: 'Custom Garment Development', desc: 'Design-based production with sampling approval and technical execution.', img: '/image/CUSTOM1.jpg', specs: ['Service: Design to Final Production','Sampling: Proto & Fit Sample Approval','Customization: Fabric, Fit & Branding','MOQ: Flexible Based on Requirement','Compliance: Export Quality Standards'] },
  { id: 15, category: 'CUSTOMMANUFACTURING', name: 'Full Production Management', desc: 'Fabric sourcing, stitching, finishing, quality inspection, and export documentation support.', img: '/image/CUSTOM2.jpg', specs: ['Process: Fabric Sourcing to Shipment','Quality Control: Multi-Level Inspection','Compliance: Ethical & Social Standards','Documentation: Export & Shipping Support','Delivery: On-Time Bulk Execution'] },
];
...
export function ProductsPage() {
  ...
  const getSliderBg = (index: number) => {
    const item = sliderImages[index];
    if (item.src) return { backgroundImage: `url(${item.src})`, backgroundSize: 'cover', backgroundPosition: 'center' };
    return { background: fallbackBgs[index % fallbackBgs.length] };
  };
    ...
    <div className="font-['Inter',sans-serif]">
        ...
        <div className="absolute inset-0">
          <div
            ...
            style={{
              ...getSliderBg(current),
              opacity: transitioning ? 0 : 1,
              animation: !transitioning ? 'kenBurns 8s ease-in-out infinite alternate' : 'none',
            }}
          />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-24">
          ...
          <div key={current} className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm" style={{ animation: 'fadeSlideUp 0.5s ease forwards' }}>
            <span className="w-1.5 h-1.5 rounded-full bg-white/80 inline-block" />
            <span className="text-white/80 text-xs tracking-wide font-medium">{sliderImages[current].label}</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-cloud-lighter">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-8 sm:mb-10 relative flex items-center gap-2">

            {/* LEFT arrow */}
            <button
              onClick={() => scrollTabs('left')}
              className={`flex-shrink-0 w-9 h-9 rounded-full border border-cloud-dark bg-white flex items-center justify-center shadow-sm transition-all duration-200 hover:bg-charcoal hover:text-white hover:border-charcoal active:scale-95 ${
            ...
            <div
              ref={tabsRef}
              className="flex gap-2 overflow-x-auto pb-0 hide-scrollbar flex-1"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {filtered.map((product) => (
              <div key={product.id} className="group bg-white rounded-xl sm:rounded-2xl overflow-hidden border border-cloud-dark hover:border-silver hover:shadow-[0_8px_30px_rgba(43,43,43,0.08)] transition-all duration-300 hover:-translate-y-1">
                <TexImg src={product.img} alt={product.name} className="w-full h-40 sm:h-44" />
                <div className="p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-bold text-charcoal mb-2 group-hover:text-charcoal-light transition-colors">{product.name}</h3>
                  <p className="text-xs sm:text-sm text-silver-darker leading-relaxed mb-3 sm:mb-4">{product.desc}</p>
                  <div className="space-y-1.5 mb-4 sm:mb-5">
                    {product.specs.map((spec) => (
                      <div key={spec} className="flex items-center gap-2">
                        <CheckCircle2 className="w-3 sm:w-3.5 h-3 sm:h-3.5 text-charcoal shrink-0" />
                  ...
                  <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-cloud-dark">
                    <button onClick={() => navigate('contact')} className="text-xs sm:text-sm font-semibold text-charcoal flex items-center gap-1 hover:gap-2 transition-all">
                      Contact us <ChevronRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                    </button>
                  </div>
                </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-4 sm:mb-6 leading-tight" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Experience Our Quality Firsthand
          </h2>
